...
function Footer() {
  return (
    <div className="w-full flex h-screen p-20">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-7xl font-bold uppercase leading-none -mb-3 tracking-tighter">
            Eye-
          </h1>
          <h1 className="text-7xl font-bold uppercase leading-none -mb-3 tracking-tighter">
            opening
      ...
      <div className="w-1/2 ">
        <h1 className="text-7xl font-bold uppercase leading-none -mb-4">
          PRESENTATIONS
        </h1>
        <div className="w-full flex">
          <div className=" mt-13 w-1/2">
            ...
            <p className="mb-5 mt-7">E :</p>
            <a className="block mb-10" href="#">
              <u>hello@ochi.design</u>
            </a>
            <p className="text-zinc-500 pt-17">
              &copy; ochi designs 2025. <u>Legal Terms</u>
            </p>
          </div>
          <div className="w-1/2 mt-55">
            <div className="pl-55">
            ...
            <p className="text-zinc-500 pt-45 pl-30">
              Website by <u>Akshat Khulbe</u>
            </p>
          </div>
        </div>
      </div>
